            ...
            <View style={styles.container}>
                <View style={styles.board}>
                    ...
                    {/* <TouchableWithoutFeedback onPress={() => {
                        const token = this.props.rTurn ? { id: this.props.turnNumber, type: 'R' } : { id: this.props.turnNumber, type: 'B' };
                        const col = 'A'
                        if (this.props.rTurn) {
                            this.props.addToken(token, col)
                        }
                    }}>
                        <View style={styles.column} >
                            <Svg
                    ...
                    <View style={styles.column}>
                        ...
                        >
                            <Circle
                                ...
                                cy="16"
                                r="15"
                                stroke={this.props.colC[1] === undefined ? 'black'
                                    : this.props.colC[1] === 'R' ? 'red' : 'blue'}
                                strokeWidth="2"
                                fill={this.props.colC[1] === undefined ? 'white'
                                    : this.props.colC[1] === 'R' ? 'red' : 'blue'}
                                fillOpacity=".3"
                            />
                        </Svg>
